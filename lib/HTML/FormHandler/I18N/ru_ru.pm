...
our %Lexicon = (
    ...
    'Value must be greater than or equal to [_1]' =>
        'значение должно быть больше или равно [_1]',
    ...
    'Must be a single line of no more than 255 chars' =>
        'Должно быть одной строкой, не более 255 символов',
    'Must be a non-empty single line of no more than 255 chars' =>
        'Должно быть не пустой строкой, не более 255 символов',
    ...
    'Must be made up of letters, digits, and underscores' =>
        'Должно состоять из букв, цифр и подчёркиваний',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'Должно быть от 8 до 255 символов, и содержать не-буквенный символ',
    ...
    # H::F::Field::Email
    'Email should be of the format [_1]' =>
        'Адрес электронной почты должен быть в формате [_1]',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'Символов должно быть не более [_1]. Вы ввели: [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'Символов должно быть не менее [_1]. Вы ввели: [_2]',
    ...
    'Your datetime does not match your pattern.' =>
        'Введённые дата/время не совпадают с вашим шаблоном.',
);
