...
our %Lexicon = (
    ...
    'Value must be greater than or equal to [_1]' =>
        'El valor ha de ser major o igual que [_1]',
    ...
    'Must be a non-empty single line of no more than 255 chars' =>
        'Ha de ser una línia text no buit de un màxim de 256 caràcters',
    'Must be made up of letters, digits, and underscores' =>
        'Nomes poden haver lletres dígits i "_"',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'hi ha de ser entre 8 i 255 caràcters i no tots lletres',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'El camp non ha de tenir mes de [quant,_1,caràcter,caràcters]. Hi ha [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'El camp ha de tenir almeys [quant,_1,caràcter,caràcters]. Hi ha [_2]',
