...
our %Lexicon = (
    ...
    'Value must be greater than or equal to [_1]' =>
        'Il valore deve essere maggiore o eguale a [_1]',
    'Value must be less than or equal to [_1]' =>
        'Il valore deve essere minore o eguale a [_1]',
    ...
    'Must be a non-empty single line of no more than 255 chars' =>
        'Deve essere un testo di una riga, non vuoto e con un massimo di 255 caratteri',
    'Must be made up of letters, digits, and underscores' =>
        'Può essere composto da lettere, cifre e "_"',
    ...
    'Must be a single line of no more than 255 chars' =>
        'Deve essere una sola riga di testo con un massimo di 255 caratteri',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'Deve essere tra 8 e 255 caratteri, e contenere non solo lettere',
    ...
    'Your datetime does not match your pattern.' =>
        q(Il formato della data non coincide con quello richiesto.),
    ...
    'The password confirmation does not match the password' =>
        'La password di verifica non coincide',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'Il campo non deve eccedere [quant,_1,carattere,caratteri]. Tu ne hai inseriti [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'Il campo deve essere di almeno [quant,_1,carattere,caratteri].  Tu ne hai inseriti [_2]',
    ...
    'Your form was successfully submitted' =>
        q(I valori sono stati inviati al server correttamente),
);
