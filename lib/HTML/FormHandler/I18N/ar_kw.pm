...
our %Lexicon = (
    ...
    'Value must be greater than or equal to [_1]' =>
        'هذه القيمة يجب أن تكون أكبر من أو تساوي [_1]',
    'Value must be less than or equal to [_1]' =>
        'هذه القيمة يجب أن تكون أصغر من أو تساوي [_1]',
    ...
    'Must be a non-empty single line of no more than 255 chars' =>
        'يجب أن تكون هذه القيمة سطرًا واحدًا غير فارغ المحتوى ولا يتعدى ٢٥٥ حرفًا',
    'Must be made up of letters, digits, and underscores' =>
        'يجب أن تكون هذه القيمة مكونة من الأحرف والأرقام وعلامة "_"',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'يجب أن تحتوي هذه الخانة على حرف واحد غير أبجدي على الأقل وأن يكون عدد الأحرف بين ٨ و ٢٥٥',

    # H::F::Field::Date
    'Date is too early' => 'هذا التاريخ مبكر',
    'Date is too late'  => 'هذا التاريخ متأخر',
    'Your datetime does not match your pattern.' =>
        q(التاريخ والوقت المدخلان لا يتطابقان مع الصياغة),
    ...
    'The password confirmation does not match the password' =>
        'تأكيد كلمة السر لا يتطابق مع الخانة الأصلية',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'هذه الخانة يجب ألّا تتعدى [quant,_1,حرف/حروف]. العدد المدخل هو [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'هذه الخانة يجب أن تحتوي على [quant,_1,حرف/حروف] على الأقل. العدد المدخل هو [_2]',
    ...
    'Value must be unique in the database' =>
        'يجب أن تكون هذه القيمة فريدة من نوعها في قاعدة البيانات',
