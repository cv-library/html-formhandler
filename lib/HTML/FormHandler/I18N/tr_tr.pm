...
our %Lexicon = (
    ...
    'Must be a single line of no more than 255 chars' =>
        '255 karakterden kısa ve tek bir satır olmalı',
    'Must be a non-empty single line of no more than 255 chars' =>
        'Boş bırakılmamalı, 255 karakterden kısa ve tek bir satır olmalı',
    ...
    'Must be made up of letters, digits, and underscores' =>
        'Sadece harf, rakam ya da "_" içerebilir',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'Harf olmayan karakter içermeli ve 8-255 karakter arasında olmalı',
    ...
    'Must be a number. May contain numbers, +, - and decimal separator \'[_1]\'', =>
        'Bir sayı olmalı. Rakamlar, +, -, ve ondalık ayırıcı \'[_1]\' içerebilir',
    'Total size of number must be less than or equal to [_1], but is [_2]', =>
        'Maksimum [_1] rakam içerebilir ama [_2] rakam içeriyor',
    'May have a maximum of [quant,_1,digit] after the decimal point, but has [_2]', =>
        'Ayraçtan sonra maksimum [_1] rakam içerebilir ama [_2] rakam içeriyor',
    ...
    'The password confirmation does not match the password' =>
        'Şifre onayı ile şifre aynı değil',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'Girilen verinin uzunluğu en fazla [_1] olabilir. Gönderilen: [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'Girilen verinin uzunluğu en az [_1] olabilir. Gönderilen: [_2]',
