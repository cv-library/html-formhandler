...
our %Lexicon = (
    ...
    'Must be a non-empty single line of no more than 255 chars' =>
        'Ha de ser una linea no vacía con 255 caracteres como maximo',
    'Must be made up of letters, digits, and underscores' =>
        'Solo se permiten letras, dígitos y "_"',
    ...
    'Must be a single line of no more than 255 chars' =>
        'Ha de ser una linea con 255 caracteres como maximo',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'A de contener entre 8 y 255 caracteres y al menos uno no alfabético',
    ...
    'Your datetime does not match your pattern.' =>
        q(El formato de la fecha no coincide con el patrón.),
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'El campo no puede exceder de [quant,_1,carácter,caracteres]. Ahora hay [_2]',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'El campo ha de tener [quant,_1,carácter,caracteres] como minimo. Ahora hay [_2]',
