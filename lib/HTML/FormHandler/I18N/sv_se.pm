...
our %Lexicon = (
    ...
    'Must be a non-empty single line of no more than 255 chars' =>
        'Ska vara en enda rad med minst ett och högst 255 tecken.',
    'Must be made up of letters, digits, and underscores' =>
        'Får bara innehålla bokstäver, siffror och understreck.',
    ...
    'Field contains non-printable characters' =>
        'Fältet innehåller tecken som inte går att skriva ut.',
    ...
    'Must be a single line of no more than 255 chars' =>
        'Ska vara en enda rad med högst 255 tecken.',
    ...
    'Must be between 8 and 255 chars, and contain a non-alpha char' =>
        'Ska vara mellan 8 och 255 tecken, och innehålla ett tecken som inte är en bokstav.',
    ...
    'Field should not exceed [quant,_1,character]. You entered [_2]' =>
        'Ska inte vara längre än [_1] tecken. Du har skrivit [_2].',
    'Field must be at least [quant,_1,character]. You entered [_2]' =>
        'Ska vara minst [_1] tecken. Du har skrivit [_2].',
