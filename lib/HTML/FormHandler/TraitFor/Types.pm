...
subtype 'HFH::ArrayRefStr' => as 'ArrayRef[Str]';

coerce 'HFH::ArrayRefStr' => from 'Str' => via {
    if ( length $_ ) { return [$_] }
    return [];
};

coerce 'HFH::ArrayRefStr' => from 'Undef' => via { return []; };

subtype 'HFH::SelectOptions' => as 'ArrayRef[HashRef]';

coerce 'HFH::SelectOptions' => from 'ArrayRef[Str]' => via {
    my @options = @$_;
...
coerce 'HFH::SelectOptions' => from 'ArrayRef[ArrayRef]' => via {
    my @options = @{ $_[0][0] };
    my $opts;
